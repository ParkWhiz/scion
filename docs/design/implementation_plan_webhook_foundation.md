# GitHub Pull Request Comment Webhook Integration (Webhook Foundation)

This design document outlines the technical plan to implement the webhook receivers on the Scion Hub server to support decoding GitHub pull request comments and detecting mentions of `@scion` (case insensitive).
